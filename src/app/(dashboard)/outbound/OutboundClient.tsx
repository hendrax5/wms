...
export default function OutboundClient() {
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className={`glass rounded-xl border ${requiresSN ? 'border-rose-500/50 ring-1 ring-rose-500/20' : 'border-[#334155] opacity-50'} overflow-hidden flex flex-col h-[600px] relative transition-all`}>
