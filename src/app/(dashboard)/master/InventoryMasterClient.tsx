...
export default function InventoryMasterClient() {
    ...
    const isMaster = (session?.user as any)?.level === "MASTER";
    ...
    return (
        <div className="space-y-4 animate-fade-in">
            ...
            {/* ── CATEGORY MODAL ── */}
            {isCatModalOpen && (
                <div className="fixed inset-0 z-[100] bg-[#020617]/80 backdrop-blur-sm flex items-center justify-center p-4" style={{animation:'fadeIn .25s ease-out'}} onClick={() => { setIsCatModalOpen(false); setErrorMsg(""); }}>
                    <div className="bg-[#0F172A] border border-[#1E293B] rounded-2xl w-full max-w-md shadow-2xl overflow-hidden" onClick={e => e.stopPropagation()}>
                        <div className="p-5 border-b border-[#1E293B] flex items-center justify-between bg-[#020617]/50">
